...
<script>
  ...
  export default {
    ...
    data() {
      return {
        failIcon: [require('./img/fail_b.png'), require('./img/fail_w.png')],
        successIcon: [
        ...
        arrowIcon: [require('./img/arrow_b.png'), require('./img/arrow_w.png')],
        loadingIcon: [
    ...
    watch: {
      refreshPer() {
        ...
        if (this.refreshPer < 100) {
          this.$refs.refresh.style.transform = `rotateZ(${this.refreshPer *
            1.8}deg)`;
        } else {
    ...
    methods: {
      ...
      loading() {
        ...
        // < this.$refs.scroll.offsetHeight
        if (
          disbottom < this.$refs.scroll.offsetHeight &&
          !this.isUploading &&
          !this.isFinish &&
